            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                @if(empty($details->avatar))
                      <img src="{{ url('public/admin/images/profile_av.png')}}" alt="user-avatar" class="profile-user-img img-fluid img-circle">
                      @else
                      <img src="{{ url($details->avatar)}}" alt="user-avatar" class="profile-user-img img-fluid img-circled">
                      @endif
                ...
                <p class="text-muted text-center">{{$details->nick_name}}</p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Dob</b> <a class="float-right">{{$details->dob}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Email</b> <a class="float-right">{{$details->email}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Mobile</b> <a class="float-right">{{$details->mobile}}</a>
                  </li>
                </ul>
   ...
   <!-- Search sections -->
          ...
          @endif
                <div class="tab-content">
                  ...
                  <form method="POST" action="{{ route('admin.user.account-update') }}" class="form-horizontal" >
                 @csrf
                 <input type="hidden" name="userId" value="{{$details->id}}">
                      ...
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Nick Name</label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Contact Details</label>
                        <div class="col-sm-10">
